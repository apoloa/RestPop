    ...
    return function (object, lang='EN') {
        ...
        if (object === null ){
            restify.RestError.call(this, {
                body: {
                    statusCode: error[lang].status,
                    message: error[lang].message,
                    code: error[lang].code
                },
                statusCode: error[lang].status,
        ...
        if (object instanceof Object) {
            ...
            restify.RestError.call(this, {
                body: {
                    statusCode: object.statusCode || error[lang].statusCode,
                    message: object.message || object,
                    code: object.code || error[lang].code
                },
                statusCode: object.statusCode || error[lang].status,
                constructOpt: functionName
            });
        } else {
            restify.RestError.call(this, {
                body: {
                    statusCode: error[lang].status,
                    message: object || error[lang].message,
                    code: error[lang].code
                },
                statusCode: error[lang].status,
                constructOpt: functionName
